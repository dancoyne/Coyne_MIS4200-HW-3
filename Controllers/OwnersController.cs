...
namespace Coyne_MIS4200.Controllers
{
    public class OwnersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ownerID,firstName,lastName,email")] Owner owner)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ownerID,firstName,lastName,email")] Owner owner)
        {
            if (ModelState.IsValid)
            {
